...
```shell
curl "http://example.com/api/v1/competitions"
...
`GET http://example.com/api/v1/competitions`

### Query Parameters

Parameter | Default | Description
--------- | ------- | -----------
limit | 50 | Limit number of competitions in response
